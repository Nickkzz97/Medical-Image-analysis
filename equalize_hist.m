function [output_img,equalized] = equalize_hist(input_img)
% The function applies histogram equalization on a single color image
% returning a single color image whose histogram is approximately flat.
